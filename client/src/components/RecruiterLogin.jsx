    ...
    const handleSubmit = (e) => {
        ...
        if (state === 'Sign Up') {
            if (!isTextDataSubmited) {
                ...
                console.log('Sign up completed with:', { name, email, password, image })
                setState('Login')
                setName('')
                setEmail('')
                setPassword('')
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="px-8 py-10">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-gray-800 mb-2">Recruiter {state}</h1>
                    ...
                    {state === 'Sign Up' && isTextDataSubmited ? (
                        <div className="mb-6">
                            <label htmlFor="company-logo" className="flex flex-col items-center cursor-pointer">
                                ...
                                <span className="text-blue-600 font-medium">Click to upload company logo</span>
                                <input 
                                    id="company-logo"
                                    type="file" 
                                    accept="image/*" 
                    ...
                    >
                        {state === 'Login' 
                            ? 'Login' 
                            : (isTextDataSubmited ? 'Complete Sign Up' : 'Continue')
                        }
                    </button>
